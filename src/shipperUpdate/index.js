...
function Shipper() {
    ...
    function handleSubmit(e) {
        e.preventDefault();
        CRUD.updateOneShipper(postData.ShipperID, postData).then((res) => {
            history.goBack();
        }).catch((err) => {
            console.log(err);
        })
                        ...
                        postData ?
                            <>
                                <div className="txtb">
                                    ...
                                    <input type="text" name="ShipperName" value={postData.ShipperName} onChange={handleChangeData} placeholder="ShipperName"></input>
                                </div>
                                <>
                                    <div className="txtb">
